...
namespace DBBroker.Migrations
{
    ...
    [Migration("20250921200640_PK_Promenjen_Stavke")]
    partial class PK_Promenjen_Stavke
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Common.Domain.StavkaServisa", b =>
                {
                    ...
                    b.HasIndex("ServisId1");

                    b.HasIndex("UslugaId");

                    b.HasIndex("ServisId", "Rb")
                        .IsUnique();
            ...
            modelBuilder.Entity("Common.Domain.StavkaServisa", b =>
                {
                    ...
                    b.HasOne("Common.Domain.Servis", null)
                        .WithMany("StavkeZaBrisanje")
                        .HasForeignKey("ServisId1");
